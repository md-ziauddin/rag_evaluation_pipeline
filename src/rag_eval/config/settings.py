...
class Settings(BaseSettings):
    ...
    DEFAULT_EMBEDDING_PROVIDER: str = Field(default="bedrock", description="Default provider ('bedrock' or 'local')")
    DEFAULT_EMBEDDING_MODEL: str = Field(default="amazon.titan-embed-text-v2:0", description="Default embedding model ID")
